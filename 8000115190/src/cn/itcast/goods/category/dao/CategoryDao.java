...
public class CategoryDao {
	...
	public List<Category> findByParent(String pid) throws SQLException {
		...
		Connection conn = DbUtils.getConnection();
		List<Map<String,Object>> mapList = qr.query(conn,sql, new MapListHandler(), pid);
	...
	public Category load(String cid) throws SQLException {
		...
		Connection conn = DbUtils.getConnection();
		return toCategory(qr.query(conn,sql, new MapHandler(), cid));
	}
	...
	public int findChildrenCountByParent(String pid) throws SQLException {
		...
		Connection conn = DbUtils.getConnection();
		Number cnt = (Number)qr.query(conn,sql, new ScalarHandler(), pid);
