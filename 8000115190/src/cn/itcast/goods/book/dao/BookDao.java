...
public class BookDao {
	...
	public Book findByBid(String bid) throws SQLException {
		...
		Map<String,Object> map = qr.query(conn,sql, new MapHandler(), bid);
	...
	public int findBookCountByCategory(String cid) throws SQLException {
		...
		Number cnt = (Number)qr.query(conn,sql, new ScalarHandler(), cid);
	...
	private PageBean<Book> findByCriteria(List<Expression> exprList, int pc) throws SQLException {
		...
		List<Book> beanList = qr.query(conn,sql, new BeanListHandler<Book>(Book.class), 
				params.toArray());
